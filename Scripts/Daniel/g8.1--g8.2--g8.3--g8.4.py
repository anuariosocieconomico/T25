...
try:
    ...
    df_final = df_final.melt(id_vars=['Produto'], var_name='Período', value_name='Valor')
    df_final['Categoria'] = df_final['Período'].str.contains('1997').map({True: 'Variação desde 1997', False: 'Variação do último ano'})
