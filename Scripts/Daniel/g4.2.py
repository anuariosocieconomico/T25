...
try:
    ...
    data = sidrapy.get_table(table_code='5603', territorial_level='3', ibge_territorial_code='28', variable='631,706',
                             period="all")
    ...
    c.to_excel(data, sheets_path, 'g4.2.xlsx')
...
if errors:
    with open(os.path.join(errors_path, 'script--g4.2.txt'), 'w', encoding='utf-8') as f:
